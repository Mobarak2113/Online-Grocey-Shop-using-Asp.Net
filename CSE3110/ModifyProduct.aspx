<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ModifyProduct.aspx.cs" Inherits="CSE3110.WebForm4" %>
        ...
        <table align="center" style="background-color:aliceblue;" class="auto-style1">
            ...
            <tr>
                <td colspan="2" width="50%" align="center">
                    <asp:Button ID="AddProduct" class="btn btn-success" runat="server" Text="Modify Product" Height="44px"  Width="130px"  />
